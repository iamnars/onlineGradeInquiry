...
<div id="main">
	...
	<a rel="facebox" href="addsub.php" id="add">Add Subject</a>
		<table cellpadding="1" cellspacing="1" id="resultTable">
			<thead>
				<tr>
					<th  style="border-left: 1px solid #FAEF92"> Subject ID </th>
					<th>Title</th>
					<th>Units</th>
					<th> Action </th>
				</tr>
				...
				while($row = $result->fetch_array())
					{
						...
						echo '<td  style="border-left: 1px solid #FAEF92">'.$row['subject_id'].'</td>';
						echo '<td><div align="left">'.$row['Title'].'</div></td>';
						echo '<td><div align="left">'.$row['unit'].'</div></td>';
						echo '<td><div align="center"><a rel="facebox" href="editsubject.php?id='.$row['id'].'">Edit</a> | <a href="#" id="'.$row['id'].'" class="delbutton" title="Click To Delete">delete</a></div></td>';
						echo '</tr>';
					}
				?> 
			</tbody>
