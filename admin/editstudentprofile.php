...
<form name="myForm" action="editstudentinfoexec.php" method="post" enctype="multipart/form-data" name="addroom" onsubmit="return validateForm()">
...
<br>
Status<br />
<select name="stat" class="textfield">
