...
<div id="main">
	...
	<div id="content">
        ...
        <input type="text" name="sy" class="textfield" value="2013-2014" />
		</select>
			...
			<?php
				...
				include('../connect.php');
                  ...
                  $result = $link->query("SELECT ss.*, ts.teacher, ts.subject, ts.section, ts.course, ts.level, ts.sy, ts.term 
                                            ...
                                            left join teachersubject ts on ss.subjectid=ts.id 
                                            ORDER BY sy, term, course,level, section ASC");
				...
				while($row = $result->fetch_array())
					{
						...
						echo '<td><div align="left"><a rel="facebox" href="editstudsub.php?id='.$row['id'].'" title="Click To Edit">Edit</a> | <a href="#" id="'.$row['id'].'" class="delbutton" title="Click To Delete">delete</a></div></td>';
						echo '</tr>';
					}
				?>
			</tbody>
