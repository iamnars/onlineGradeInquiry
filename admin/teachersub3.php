		...
		<table cellpadding="1" cellspacing="1" id="resultTable">
			...
			<?php
				...
				include('../connect.php');
                  ...
                  $result = mysql_query("SELECT teachersubject.*, teacher.fname, teacher.lname FROM teachersubject LEFT JOIN teacher ON teachersubject.teacher = teacher.idnumber
                  ORDER BY teacher, term, sy, section, course, level ASC");
				...
				while($row = mysql_fetch_array($result))
					{
						...
						echo '<td><div align="center"><a rel="facebox" href="editteachersub.php?id='.$row['id'].'" title="Click To Edit">Edit Profile</a> | <a href="#" id="'.$row['id'].'" class="delbutton" title="Click To Delete">delete</a></div></td>';
						echo '</tr>';
					}
				?>
			</tbody>
